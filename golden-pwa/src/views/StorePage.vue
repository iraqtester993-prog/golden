...
<style scoped>.subcategories{display:flex;gap:7px;overflow:auto;padding:0 1px}.subcategories button{flex:none;padding:7px 12px;border:1px solid var(--outline-variant);border-radius:18px;background:var(--surface-container);color:var(--on-surface-variant);font:inherit;font-size:10px;cursor:pointer}.section-branch{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));overflow:visible}.section-branch button{width:100%;min-width:0}.subcategories button.active{border-color:var(--primary);background:rgba(196,154,59,.12);color:var(--primary)}.main-back{grid-column:1/-1;display:flex!important;align-items:center;justify-content:center;gap:3px;border-color:var(--primary)!important;color:var(--primary)!important}.main-back .material-symbols-outlined{font-size:15px}.installment-strip{display:flex;align-items:center;justify-content:center;gap:5px;margin-top:9px;padding:7px;border-radius:9px;background:rgba(196,154,59,.11);color:var(--primary);font-size:10px;font-weight:700}.installment-strip .material-symbols-outlined{font-size:15px}</style>
